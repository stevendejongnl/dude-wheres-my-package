...
VAPID_SUBJECT. Generate them once with:
    ...
    v = Vapid()
    v.generate_keys()
    n = v.public_key.public_numbers()
    pub_raw = b'\\x04' + n.x.to_bytes(32, 'big') + n.y.to_bytes(32, 'big')
    print('VAPID_PUBLIC_KEY=' + base64.urlsafe_b64encode(pub_raw).rstrip(b'=').decode())
    priv_raw = v.private_key.private_numbers().private_value.to_bytes(32, 'big')
    print('VAPID_PRIVATE_KEY=' + base64.urlsafe_b64encode(priv_raw).rstrip(b'=').decode())
    "
"""
